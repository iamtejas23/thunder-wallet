...
const styles = StyleSheet.create({
  ...
  title: { color: '#F9FAFB', fontSize: 22, fontWeight: '900', marginTop: 8 },
  subtitle: { color: 'rgba(249,250,251,0.3)', fontSize: 13, fontWeight: '600' },
  ...
  keyText: { color: '#F9FAFB', fontSize: 26, fontWeight: '700' },
  bottomRow: { flexDirection: 'row', gap: 20, alignItems: 'center' },
  bioBtn: { alignItems: 'center', gap: 6 },
  bioBtnText: { color: '#A78BFA', fontSize: 12, fontWeight: '700' },
  cancelBtn: { paddingHorizontal: 20, paddingVertical: 10 },
  cancelText: { color: 'rgba(249,250,251,0.4)', fontSize: 14, fontWeight: '700' },
});
