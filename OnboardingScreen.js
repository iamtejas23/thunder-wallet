...
const styles = StyleSheet.create({
  ...
  title: { color: '#F9FAFB', fontSize: 30, fontFamily: 'DMSans_900Black', letterSpacing: -0.5, textAlign: 'center', lineHeight: 38, marginBottom: 14 },
  ...
  rupeeSymbol: { color: '#60A5FA', fontSize: 28, fontFamily: 'DMSans_900Black', letterSpacing: -0.5, marginRight: 8 },
  budgetInput: { flex: 1, color: '#F9FAFB', fontSize: 32, fontFamily: 'DMSans_900Black', letterSpacing: -0.5 },
  ...
  presetText: { color: 'rgba(249,250,251,0.5)', fontSize: 13, fontFamily: 'DMSans_700Bold' },
  ...
  notifBtnText: { color: '#60A5FA', fontSize: 14, fontFamily: 'DMSans_800ExtraBold' },
  ...
  nextBtnText: { color: '#000', fontSize: 16, fontFamily: 'DMSans_900Black' },
});
